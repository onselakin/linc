...
const Stepper = () => {
  ...
  return (
    <div className="w-full prose max-w-none mb-8">
      <h1 className="text-sm text-orange my-1">{currentScenario.title ? currentScenario.title : currentLab.title}</h1>
      <div className="flex-1 flex justify-between border-t-2 border-gray-500 mt-4">
        ...
        {currentScenario.steps.length === 1 && (
          <div className="w-4 h-4 rounded-full -mt-2 border border-gray-600 bg-gray-500" />
        )}
      </div>
